...
var urlByType = function (type) {
    ...
    switch (type) {
        case "index":       //首页
            url = "index.html";
            break;
        case "news_center":      //新闻中心
            url = "pages/news_center/news_center.html";
            break;
        case "contact_us":       //联系我们
            url = "pages/contact_us/contact_us.html";
            break;
        // case "commerce":        //商业保险
...
var getInterface = function () {
    ...
    if (host.indexOf("localhost") > -1) {       //本地路径 arya-core的端口
        $interface = "http://localhost:8082/arya-core/";
    }
